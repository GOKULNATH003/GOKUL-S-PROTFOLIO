            ...
            <div className="Home_container">
                <div className="homeHeader d-flex justify-end ">
                    ...
                    <nav className=" d-flex g5 m5 ">
                        <a rel="noreferrer" href="https://www.linkedin.com/in/gokulnath-s-b05b9b1ab" target="_blank" className="a1"> <i className="fa-brands fa-linkedin"></i></a>
                        <a rel="noreferrer" href="https://github.com/GOKULNATH003" className="a2" target="_blank"><i className="fa-brands fa-github-square"></i></a>
                        <a rel="noreferrer" href="mailto:gn98169@gmail.com" className="a3" target="_blank"><i className="fa-solid fa-envelope"></i></a>
                        <a rel="noreferrer" href="https://twitter.com/GOCOOL_IDHAY?t=hvQsOGKHKuU7wVcankLFYg&s=08" className="a4" target="_blank"><i className="fa-brands fa-twitter-square"></i></a>
                        <a rel="noreferrer" href="tel:9789697257" className="a5" target="_blank" title="9789697257"><i className="fa-solid fa-phone"></i></a>
                    </nav>
                </div>
                <div className='nav_bar '>
                    {!overlay &&

                        <img src={hamBurger} className='hamburger pointer' onClick={() => { setOverlay((prev) => !prev) }} alt="" />
                    }
                </div>
                <div className="topContent d-flex justify-between align-center">
                    ...
                    <div className="topRightContent">
                        <div className="img_displayer">
                            <img draggable="false" src={profile} className='profile_img' alt="" />
                        </div>
                    </div>
                </div>
                {
                    ...
                    <div className="btn_container">
                        <button className='viewMoreBtn' onClick={(e) => { setPageState((prev) => !prev) }}>View {pageState ? "less" : "more"}</button>
                    </div>
                }
                        ...
                        <div className="bottom_container">
                            <div className="grad_details d-flex justify-between align-center"  >
                                <div className='grad_content' >
                                    <p>
                                        Hi! I completed my bachelors degree in<b> Mechanical Engineering </b>in the year of<b> 2017-2021 </b> with the CGPA of<b> 7.76 CGPA </b>
                                    </p>
                                </div>
                                <img draggable="false" src={grad_img} className='bottom_img' alt="graduationcap" />
                            </div>

                            <div className="core_details d-flex justify-between align-center g2" >
                                <img draggable="false" src={planning} className='bottom_img' alt="mechanicalimg" />
                                <div className='grad_content' >
                                    <p>
                                        After my graduation, I joined a mechanical-based company as a Graduate Engineer Trainee (GET). The company is a supplier of Caterpillar Mining vehicles, manufacturing the body and cabin of the mining vehicles. After three months, I left to improve my skills.                                    </p>
                                </div>
                            </div>
                            <div className="grad_details d-flex justify-between align-center" >
                                <div className='grad_content' >
    ...
    return (
        <div className="overlay">
            <div className='d-flex fdc overlay_content '>
                <img src={close} className='hamburger1' onClick={() => { setOverlay(false) }} alt="" />

                <a rel="noreferrer" href="https://www.linkedin.com/in/gokulnath-s-b05b9b1ab" target='_blank'>Linked In</a>
                <a rel="noreferrer" href="https://github.com/GOKULNATH003" target='_blank'>Git Hub</a>
                <a rel="noreferrer" href="mailto:gn98169@gmail.com" target='_blank'>E-Mail</a>
                <a rel="noreferrer" href="https://twitter.com/GOCOOL_IDHAY?t=hvQsOGKHKuU7wVcankLFYg&s=08" target='_blank'>Twitter</a>
                <a rel="noreferrer" href="tel:9789697257" class="a5" target="_blank" title="9789697257">Contact</a>
            </div>
